    ...
    <div class="layui-row">
        <div class="layui-col-md3">
            ...
            <div class="layui-input-block">
                ...
                <%--</select>--%>
                <input type="text" name="awardName" placeholder=""
...
<script>
    layui.config({
        ...
        $(document).on('click','.search',function(){
            ...
            qurryByParam(awardName,level);
        });
        function qurryByParam(awardName,level){
            var t = {};
        ...
        function Table() {
            ...
            table.render({
                ...
                , cols: [[
                    { field: 'awardName', width: 100, title: '奖项', sort: true }
                    , { field: 'punishTime', width: 180, title: '处分时间' }
                    , { field: 'level', width: 100, title: '处分级别', sort: true }
                    , { field: 'reason', width: 428, title: '事由' }
                    , { field: 'result', width: 120, title: '是否解除', sort: true }
                    , { field: 'relieveTime', width: 180, title: '解除时间', sort: true }
                ]]
            })
        }
