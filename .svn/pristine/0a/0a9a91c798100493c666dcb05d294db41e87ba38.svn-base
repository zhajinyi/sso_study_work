...
<div class="layui-fluid">
    <form class="layui-form" action="${ctx}/sys/Dict/add/parents" lay-filter="component-form-group">

        <input type="hidden" name="label" lay-verify="required"  autocomplete="off" class="layui-input">

        <div class="layui-form-item">
            <label class="layui-form-label">字典组id：</label>
