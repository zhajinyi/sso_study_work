...
<head>
    <meta charset="utf-8">
    <title>苏州工业园区服务外包学院-学工系统-校级优秀班级管理</title>
...
<script>
    layui.config({
        ...
        function Table() {
            table.render({
                elem: '#tableData'
                , url: '${ctx}/excellClass/onestudent/excellClassInfos' //模拟接口
                ...
                , cols: [[
                    { field: 'className', title: '获奖班级', align: 'center' }
                    , { field: 'excellclassTime', title: '获奖时间', sort: true, align: 'center' }
                    , { field: 'excellYear', title: '获奖学期', align: 'center' }
