            ...
            <form class="layui-form" lay-filter="component-form-group" id="iframeForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="empcode" placeholder="请输入" autocomplete="off" class="layui-input" lay-verify="id"readonly>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">获奖学年</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="excellYear" placeholder="请输入" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="excellclassTime" placeholder="请输入" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline" style="width: 67%">
                            ...
                            <div class="layui-input-inline">
                                <textarea name="mainStrong" placeholder="请输入" class="layui-textarea" style="width: 255%"></textarea>
                            </div>
                        </div>
                    </div>
...
<script>
    layui.config({
        ...
        function multiSearchDefaultData(){
            $("#iframeForm input[name=empcode]").attr("readonly",false);
            $("#formSubmit").html("查询");
        }
